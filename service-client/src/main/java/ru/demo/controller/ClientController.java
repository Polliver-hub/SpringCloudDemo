...
public class ClientController {
    ...
    public ClientController(
        ...
        // ПАТТЕРНЫ ПРЕДОХРАНИТЕЛЬ И ОГРАНИЧИТЕЛЬ КОЛИЧЕСТВА ЗАПРОСОВ
        // мы выделяем 200мс c помощью circuitBreaker на выполнения запроса doRequest на поход в Эврику и в клиент-инфо
        // и благодаря этому не блокируем поток tomcat
